...
def buyer_report(start, end, account = ""):
  ...
  for phone in phones:
    ...
    for br in buyer.all().values:
      ...
      buffer_.append(address.query(br.address).get("RecipientName"))
      buffer_.append(address.query(br.address).get("Address1"))
      buffer_.append(address.query(br.address).get("Address2"))
      buffer_.append(address.query(br.address).get("City"))
      buffer_.append(address.query(br.address).get("Zip"))
      buffer_.append(address.query(br.address).get("State"))
      buffer_.append(address.query(br.address).get("PhoneNumber"))
      buffer_.append(bankcard.query(br.bankcard).get("BankNumber"))
